...
<body class="font-sans">
  ...
  <section class="px-[5%] p-6 bg-gray-900 rounded-xl shadow-lg mt-8 ml-10 mr-10">
    <div class="flex flex-col md:flex-row gap-6 items-center">
      ...
      <div class="flex-shrink-0 w-full md:w-1/2">
        <img src="../images/Coffee Shop/1.png" alt="Main Project" class="rounded-lg w-full shadow-md" />
      </div>
      <!-- Right: Description + Button -->
      <div class="w-full md:w-1/2 text-left">
        <h1 class="text-3xl font-bold mb-8">Coffee Shop (Product Management)</h1>
        ...
        <a href="../Links/Coffee Shop/Product.html" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-5 rounded-full transition">
  ...
  <section class="px-[2%] p-1 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-10 mt-10">
    ...
    <div class="bg-gray-900 p-3 rounded-lg shadow-md hover:scale-105 hover:shadow-xl transition transform duration-300 cursor-pointer" onclick="openModal(1)">
      <img src="../images/Coffee Shop/1.png" class="rounded-md mb-3 w-full" />
    ...
    <div class="bg-gray-900 p-3 rounded-lg shadow-md hover:scale-105 hover:shadow-xl transition transform duration-300 cursor-pointer" onclick="openModal(2)">
      <img src="../images/Coffee Shop/1.1.png" class="rounded-md mb-3 w-full" />
      <h2 class="text-lg font-semibold text-center">Add Product</h2>
    </div>
    <div class="bg-gray-900 p-3 rounded-lg shadow-md hover:scale-105 hover:shadow-xl transition transform duration-300 cursor-pointer" onclick="openModal(3)">
      <img src="../images/Coffee Shop/2.png" class="rounded-md mb-3 w-full" />
      <h2 class="text-lg font-semibold text-center">Edit Product (Basic Information)</h2>
    </div>
    <div class="bg-gray-900 p-3 rounded-lg shadow-md hover:scale-105 hover:shadow-xl transition transform duration-300 cursor-pointer" onclick="openModal(4)">
      <img src="../images/Coffee Shop/3.png" class="rounded-md mb-3 w-full" />
      <h2 class="text-lg font-semibold text-center">Edit Product (Variant Information)</h2>
    </div>
    <div class="bg-gray-900 p-3 rounded-lg shadow-md hover:scale-105 hover:shadow-xl transition transform duration-300 cursor-pointer" onclick="openModal(5)">
      <img src="../images/Coffee Shop/4.png" class="rounded-md mb-3 w-full" />
      <h2 class="text-lg font-semibold text-center">View Variants</h2>
    </div>
    <div class="bg-gray-900 p-3 rounded-lg shadow-md hover:scale-105 hover:shadow-xl transition transform duration-300 cursor-pointer" onclick="openModal(6)">
      <img src="../images/Coffee Shop/5.png" class="rounded-md mb-3 w-full" />
...
<?php include '../components/footer.php'; ?>
  ...
  <script>
    const images = [{
        src: "../images/Coffee Shop/1.png",
        title: "Dashboard"
      },
      {
        src: "../images/Coffee Shop/1.1.png",
        title: "Add Product"
      },
      {
        src: "../images/Coffee Shop/2.png",
        title: "Edit Product (Basic Information)"
      },
      {
        src: "../images/Coffee Shop/3.png",
        title: "Edit Product (Variant Information)"
      },
      {
        src: "../images/Coffee Shop/4.png",
        title: "View Variants"
      },
      {
        src: "../images/Coffee Shop/5.png",
        title: "Categories"
      },
      {
        src: "../images/Coffee Shop/5.1.png",
