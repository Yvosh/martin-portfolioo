...
<body class="font-sans">
    ...
    <section class="px-[5%] p-6 bg-gray-900 rounded-xl shadow-lg mt-8 ml-10 mr-10">
        <div class="flex flex-col md:flex-row gap-6 items-center">
            <!-- Left: Main Image -->
            <div class="flex-shrink-0 w-full md:w-2/6">
                <div class="flex space-x-2">
                    <img src="../images/Recharge/1.png" alt="Main Project" class="rounded-lg w-2/4 shadow-md" />
                    <img src="../images/Recharge/3.png" alt="Main Project" class="rounded-lg w-2/4 shadow-md" />
                </div>
            </div>

            <!-- Right: Description + Button -->
            <div class="w-full md:w-1/2 text-left">
                <h1 class="text-3xl font-bold mb-10">Recharge (EcoPoints Charging System)</h1>
                <p class="text-gray-740 mb-5"><strong>Role: Front-End</strong><br /></p>
                <p class="text-gray-300 mb-10">
                    Category: Web Application (Designed for Phones)<br />
                    Status: Completed<br />
                    Client: Student from PLV <br />
                    Platform: HTML, JS, and Tailwind CSS <br> <br>
                    Purpose: School Project <br>
                    Client Request: Use only HTML, CSS, and JavaScript, and ensure the website is responsive and optimized for mobile phones. <br>
                    Focus: Mobile-Responsive Design
                </p>
                <p class="text-gray-740 mb-5"><strong>To visit the link, click the button below.</strong><br /></p>
                <a href="../Links/Recharge/Dashboard.html" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-5 rounded-full transition mb-4">
    ...
    <section class="px-[2%] p-1 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-10 mt-10">
        ...
        <div class="bg-gray-900 p-3 rounded-lg shadow-md hover:scale-105 hover:shadow-xl transition transform duration-300 cursor-pointer" onclick="openModal(1)">
            <img src="../images/Recharge/1.png" class="rounded-md mb-3 w-full" />
        ...
        <div class="bg-gray-900 p-3 rounded-lg shadow-md hover:scale-105 hover:shadow-xl transition transform duration-300 cursor-pointer" onclick="openModal(2)">
            <img src="../images/Recharge/2.png" class="rounded-md mb-3 w-full" />
            <h2 class="text-lg font-semibold text-center">Dashboard (Account)</h2>
        </div>
        <div class="bg-gray-900 p-3 rounded-lg shadow-md hover:scale-105 hover:shadow-xl transition transform duration-300 cursor-pointer" onclick="openModal(3)">
            <img src="../images//Recharge/3.png" class="rounded-md mb-3 w-full" />
            <h2 class="text-lg font-semibold text-center">Leadboards</h2>
        </div>
        <div class="bg-gray-900 p-3 rounded-lg shadow-md hover:scale-105 hover:shadow-xl transition transform duration-300 cursor-pointer" onclick="openModal(4)">
            <img src="../images/Recharge/4.png" class="rounded-md mb-3 w-full" />
            <h2 class="text-lg font-semibold text-center">Leadboards (Popup Notification)</h2>
        </div>
        <div class="bg-gray-900 p-3 rounded-lg shadow-md hover:scale-105 hover:shadow-xl transition transform duration-300 cursor-pointer" onclick="openModal(5)">
            <img src="../images/Recharge/5.png" class="rounded-md mb-3 w-full" />
...
<?php include '../components/footer.php'; ?>
    ...
    <script>
        const images = [{
            ...
            {
                src: "../images/Recharge/2.png",
                title: "Dashboard (Account)"
            },
            {
                src: "../images/Recharge/3.png",
                title: "Leadboards"
            },
            {
                src: "../images/Recharge/4.png",
                title: "Leadboards (Popup Notification)"
            },
            {
                src: "../images/Recharge/5.png",
                title: "Notification"
            }
        ];
